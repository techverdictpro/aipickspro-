(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68287,e=>{"use strict";var s=e.i(43476),a=e.i(71645);let r={"Premier League":"🏴󠁧󠁢󠁥󠁮󠁧󠁿",Championship:"🏴󠁧󠁢󠁥󠁮󠁧󠁿","Scottish Premiership":"🏴󠁧󠁢󠁳󠁣󠁴󠁿","La Liga":"🇪🇸","La Liga 2":"🇪🇸","Serie A":"🇮🇹","Serie B":"🇮🇹",Bundesliga:"🇩🇪","Bundesliga 2":"🇩🇪","Ligue 1":"🇫🇷","Ligue 2":"🇫🇷",Eredivisie:"🇳🇱","Primeira Liga":"🇵🇹","Belgian Pro League":"🇧🇪","Super Lig":"🇹🇷","Greek Super League":"🇬🇷","Swiss Super League":"🇨🇭","Austrian Bundesliga":"🇦🇹","Danish Superliga":"🇩🇰","Norwegian Eliteserien":"🇳🇴","Swedish Allsvenskan":"🇸🇪","Polish Ekstraklasa":"🇵🇱","Czech Liga":"🇨🇿","Romanian Liga 1":"🇷🇴",MLS:"🇺🇸","Liga MX":"🇲🇽",Brasileirao:"🇧🇷","Argentine Primera":"🇦🇷","Copa Libertadores":"🏆","Copa Sudamericana":"🏆","J-League":"🇯🇵","K-League":"🇰🇷","Saudi Pro League":"🇸🇦","Champions League":"🏆","Europa League":"🏅","Conference League":"🎖️"};e.s(["default",0,function({allResults:e,lifetimeStats:t}){let[i,o]=(0,a.useState)([]),[n,l]=(0,a.useState)(!1);(0,a.useEffect)(()=>{let s=Date.now()-6048e5;o(e.filter(e=>{let a=new Date(e.match_date||e.validated_at).getTime();return isFinite(a)&&a>=s}).sort((e,s)=>new Date(s.match_date||s.validated_at).getTime()-new Date(e.match_date||e.validated_at).getTime())),l(!0)},[e]);let d=i.filter(e=>!0===e.pick_won).length,c=i.filter(e=>!1===e.pick_won).length,p=d+c,g=p?Math.round(d/p*100):0,x=t?t.wins:d,h=t?t.losses:c,m=t?t.hitRate:g,f=t?t.roi:null,u={};for(let e of i){let s=(e.match_date||e.validated_at).split("T")[0];(u[s]||=[]).push(e)}let b=Object.keys(u).sort((e,s)=>s.localeCompare(e));return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("style",{children:`
      ...
      `}),(0,s.jsxs)("nav",{children:[(0,s.jsxs)("a",{href:"/",className:"logo",children:["Ai",(0,s.jsx)("span",{className:"logo-accent",children:"Picks"}),"Pro"]}),(0,s.jsxs)("div",{className:"nav-links",children:[(0,s.jsx)("a",{href:"/football/",children:"Football"}),(0,s.jsx)("a",{href:"/basketball/",children:"Basketball"}),(0,s.jsx)("a",{href:"/tennis/",children:"Tennis"}),(0,s.jsx)("a",{href:"/nfl/",children:"NFL"}),(0,s.jsx)("a",{href:"/tips-today/",children:"Today's Tips"}),(0,s.jsx)("a",{href:"/results/",className:"nav-active",children:"Results"})]}),(0,s.jsx)("a",{href:"/tips-today/",className:"nav-cta",children:"FREE PICKS"})]}),(0,s.jsx)("div",{className:"page-header",children:(0,s.jsxs)("div",{className:"page-header-inner",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{className:"page-label",children:"📊 Track Record"}),(0,s.jsxs)("h1",{className:"page-title",children:["Results & ",(0,s.jsx)("em",{children:"Verdicts"})]}),(0,s.jsx)("p",{className:"page-sub",children:t?`All-time record across ${x+h} settled picks. Match list below shows the last 7 days.`:"Every settled prediction from the last 7 days with the final score — win or lose, fully transparent."})]}),(0,s.jsxs)("div",{className:"scoreboard",children:[(0,s.jsxs)("div",{className:"sb-item sb-won",children:[(0,s.jsx)("strong",{children:x}),(0,s.jsx)("span",{children:"Won"})]}),(0,s.jsxs)("div",{className:"sb-item sb-lost",children:[(0,s.jsx)("strong",{children:h}),(0,s.jsx)("span",{children:"Lost"})]}),(0,s.jsxs)("div",{className:"sb-item sb-rate",children:[(0,s.jsxs)("strong",{children:[m,"%"]}),(0,s.jsx)("span",{children:"Hit Rate"})]}),null!==f&&(0,s.jsxs)("div",{className:"sb-item sb-roi",children:[(0,s.jsxs)("strong",{children:[f>0?"+":"",f,"%"]}),(0,s.jsx)("span",{children:"ROI"})]})]})]})}),(0,s.jsx)("div",{className:"main",children:n?0===b.length?(0,s.jsxs)("div",{className:"empty",children:[(0,s.jsx)("div",{className:"empty-title",children:"No settled results yet"}),(0,s.jsx)("div",{className:"empty-sub",children:"Once today's matches finish, verified results appear here with final scores."})]}):b.map(e=>(0,s.jsxs)("div",{className:"day-group",children:[(0,s.jsxs)("div",{className:"day-header",children:[new Date(e).toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"}),(0,s.jsxs)("span",{children:[u[e].filter(e=>e.pick_won).length,"W · ",u[e].filter(e=>!e.pick_won).length,"L"]})]}),u[e].map(e=>{let a=e.pick_won?"won":"lost";return(0,s.jsxs)("a",{href:`/predictions/${e.slug}/`,className:`result-row ${a}`,children:[(0,s.jsx)("div",{className:`r-badge ${a}`,children:e.pick_won?"✓":"✗"}),(0,s.jsxs)("div",{className:"r-main",children:[(0,s.jsx)("div",{className:"r-title",children:e.title}),(0,s.jsxs)("div",{className:"r-meta",children:[(0,s.jsx)("span",{children:r[e.league]||"⚽"}),(0,s.jsx)("span",{className:"r-league",children:e.league}),(0,s.jsx)("span",{children:"·"}),(0,s.jsxs)("span",{className:"r-pick",children:[e.pick_code," @ ",e.odds]})]})]}),null!=e.actual_home_score&&(0,s.jsxs)("div",{className:`r-score ${a}`,children:[(0,s.jsxs)("strong",{children:[e.actual_home_score,"–",e.actual_away_score]}),(0,s.jsx)("span",{children:"Final"})]}),(0,s.jsxs)("div",{className:"r-odds",children:[(0,s.jsx)("strong",{children:e.odds}),(0,s.jsx)("span",{children:"Odds"})]})]},e.slug)})]},e)):null}),(0,s.jsxs)("div",{className:"rg-bar",children:[(0,s.jsx)("strong",{style:{color:"#fff"},children:"⚠ Gamble Responsibly."})," 18+ only. Past results do not guarantee future outcomes."]})]})}],68287)}]);