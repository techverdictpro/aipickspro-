...
function getArticles() {
  const dir = path.join(process.cwd(), 'content', 'predictions', 'tennis')
      ...
      <div className="page-header">
        <div className="page-header-inner">
          <div className="breadcrumb">
            <a href="/">Home</a> › <span>Tennis Predictions</span>
          </div>
          <h1 className="page-title">Tennis<br /><em>Predictions</em></h1>
          <p className="page-subtitle">AI-powered tennis tips across Grand Slams, ATP, WTA and more. Surface analysis and head-to-head data. Updated daily.</p>
        </div>
      </div>
        ...
        <div className="articles-list">
          {articles.length === 0 ? (
            <div className="empty-state">
              ...
              <div>Our AI agents are analysing upcoming tennis matchups. Check back shortly.</div>
            </div>
          ) : articles.map((a: any) => (
        ...
        <div className="sidebar">
          ...
          <div className="sidebar-card" style={{ background: 'rgba(232,240,66,0.04)', borderColor: 'rgba(232,240,66,0.2)' }}>
            ...
            <p style={{ fontSize: '13px', color: '#8a8f99', marginBottom: '14px', lineHeight: '1.6' }}>
              Join 12,000+ bettors receiving our AI tennis picks every morning.
            </p>
            <input
              type="email"
