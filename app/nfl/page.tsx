...
function getArticles() {
  const dir = path.join(process.cwd(), 'content', 'predictions', 'nfl')
      ...
      <div className="page-header">
        <div className="page-header-inner">
          <div className="breadcrumb">
            <a href="/">Home</a> › <span>NFL Predictions</span>
          </div>
          <h1 className="page-title">NFL<br /><em>Predictions</em></h1>
          <p className="page-subtitle">AI-powered NFL tips with spread, moneyline and totals analysis. ATS records, situational stats, and injury reports. Updated daily.</p>
        </div>
      </div>
        ...
        <div className="articles-list">
          {articles.length === 0 ? (
            <div className="empty-state">
              ...
              <div>Our AI agents are analysing upcoming NFL matchups. Check back shortly.</div>
            </div>
          ) : articles.map((a: any) => (
        ...
        <div className="sidebar">
          <div className="sidebar-card">
            ...
            {[
              ...
              { name: 'BetMGM', bonus: '$1500 first bet' },
            ].map((bm) => (
          ...
          <div className="sidebar-card" style={{ background: 'rgba(232,240,66,0.04)', borderColor: 'rgba(232,240,66,0.2)' }}>
            ...
            <p style={{ fontSize: '13px', color: '#8a8f99', marginBottom: '14px', lineHeight: '1.6' }}>
              Join 12,000+ bettors receiving our AI NFL picks every morning.
            </p>
            <input
              type="email"
