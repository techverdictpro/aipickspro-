...
export default function NFLPage() {
  const articles = getArticles('nfl')
    ...
    <>
      ...
      <div className="page-header">
        <div className="page-header-inner">
          ...
          <p className="page-subtitle">AI-powered NFL picks with spread, moneyline and totals analysis</p>
        </div>
      </div>
      ...
      <div className="main">
        {recent.length === 0 ? (
          ...
          <div>
            <div className="section-title">NFL<span className="section-count">{recent.length} tips</span></div>
